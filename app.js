(function () {
  ...
  (function () {
    ...
    $("#predIframe").src = (pc.file || "predictor.html") + "?v=59";
  })();
  ...
  (function () {
    ...
    var f = $("#mmIframe"); if (f) f.src = (mc.file || "moviemode.html") + "?v=59";
  })();
  ...
  /* FOOTER */
  $("#footLine").innerHTML = num(st.films)+" films, "+st.reviews+" reviews, "+st.lists+" lists, every rating and word by "+esc(pr.name)+".";
